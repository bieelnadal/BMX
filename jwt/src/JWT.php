...
class JWT
{
    private static $ASN1_INTEGER = 0x02;
    private static $ASN1_SEQUENCE = 0x10;
    private static $ASN1_BIT_STRING = 0x03;
     ...
     */
    public static function decode(string $jwt, $keyOrKeyArray)
    {
        // Validate JWT
        $timestamp = \time();
     ...
     * @return Key
     */
    private static function getKey($keyOrKeyArray, $kid)
    {
     ...
     * @return bool
     */
    public static function constantTimeEquals(string $left, string $right)
    {
     ...
     */
    private static function signatureToDER(string $sig)
    {
     ...
     */
    private static function encodeDER(int $type, string $value){
        $tag_header = 0;
     ...
     */
    private static function signatureFromDER(string $der, int $keySize)
    {
