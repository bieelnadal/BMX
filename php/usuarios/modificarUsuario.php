<?php
  ...
  if (isset($user->pass)) {
    ...
    // encriptar pass
    $encryptedPass = sha1($alumno->pass);
    $queryUpdate = "UPDATE `usuarios` SET `Email`='$user->Email',`Passcode`='$encryptedPass',`Nombre`='$user->Nombre',`Apellidos`='$user->Apellidos',`Imagen`='$user->Imagen' WHERE idUsuario = $user->idUsuario";
    ...
    $queryUpdateSinPass = "UPDATE `usuarios` SET `Email`='$user->Email',`Nombre`='$user->Nombre',`Apellidos`='$user->Apellidos',`Imagen`='$user->Imagen', `DNI`='$user->DNI' WHERE idUsuario = $user->idUsuario";
